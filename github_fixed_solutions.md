...
#### Formulas Used
-$P = IV$-$V = \frac{P}{I}$#### Step-by-Step Solution
1. **Identify Given Values**:
...
#### Formulas Used
- Heat required for temperature change:$Q = mc\Delta T$- Heat required for phase change:$Q = mL$- Total heat:$Q_{total} = Q_{vaporization} + Q_{temperature}$#### Step-by-Step Solution
1. **Identify Given Values**:
...
- **Kinetic Energy**:$K = \frac{1}{2}mv^2$- **Gravitational Potential Energy**:$U = -\frac{G m_1 m_2}{r}$#### Formulas Used
...
4. **Example calculation for the first interval:**
   -$\Delta t_1 = 5200 - 2600 = 2600 \text{ s}$-$v_1 = 3.88 \text{ km/s} = 3880 \text{ m/s}$- Distance for first interval:$d_1 = 3880 \times 2600 = 10088000 \text{ m}$5. **Repeat for all intervals and sum:**
   - Total distance$d \approx \sum d_i$#### Final Answer
...
#### Formulas Used
- Ohm's Law:$I = \frac{V}{R}$#### Step-by-Step Solution
...
#### Formulas Used
- Average Speed:$v_{avg} = \frac{d}{t}$#### Step-by-Step Solution
...
#### Formulas Used
- Faraday's Law:$\mathcal{E} = -N \frac{d\Phi}{dt}$#### Step-by-Step Solution
...
3. **Use Faraday's Law to find the change in magnetic flux ($\Delta \Phi$):**
   ...
   - Approximate$\frac{\Delta \Phi}{\Delta t} \approx \frac{\Delta U}{N}$- Then$\Delta \Phi \approx \frac{\Delta U \cdot \Delta t}{N}$- Substitute the values:
...
#### Step-by-Step Solution
1. **Given Data:**
   - Total density of deuterium and tritium:$5.1 \times 10^{19} \text{ m}^{-3}$- Volume of the plasma:$38.8 \text{ m}^3$2. **Calculate Total Number of Particles:**
...
#### Step-by-Step Solution
1. **Given Data:**
   - Power output:$10.7 \text{ MW} = 10.7 \times 10^{6} \text{ W}$- Volume:$38.8 \text{ m}^3$- Density:$5.1 \times 10^{19} \text{ m}^{-3}$2. **Find Reactivity from Graph:**
...
#### Formulas Used
- Heat required to raise temperature:$Q = mc\Delta T$- Heat required to vaporize water:$Q = mL$- Total energy:$Q_{\text{ total}} = mc\Delta T + mL$- Power and time relation:$P = \frac{Q_{\text{ total}}}{t}$#### Step-by-Step Solution
1. **Identify Given Values**:
   ...
   - Specific heat capacity of water,$c = 4.18 \, \text{kJ/(kg}^\circ\text{ C})$- Latent heat of vaporization,$L = 2260 \, \text{kJ/kg}$- Power,$P = 4.0 \, \text{ W}$2. **Calculate Heat to Raise Temperature**:
...
#### Step-by-Step Solution
1. **Given Data**:
   - Mass of$^{10}\text{ Be}$in the atmosphere:$m = 1.2 \times 10^{5} \text{ kg}$- Molar mass of$^{10}\text{ Be}$:$M = 10 \text{ g/mol} = 0.01 \text{ kg/mol}$- Half-life of$^{10}\text{ Be}$:$T_{1/2} = 1.39 \times 10^{6} \text{ years}$2. **Calculate the Number of Atoms ($N$)**:
...
2. **Calculate Spring Constant$k$**:
   ...
   - Use the data points to calculate$k$for each pair:
     - For$l = 2.6 \, \text{ m}$,$F = 13.8 \, \text{ N}$:$k = \frac{13.8}{2.6} \approx 5.31 \, \text{N/m}$- For$l = 2.8 \, \text{ m}$,$F = 18.9 \, \text{ N}$:$k = \frac{18.9}{2.8} \approx 6.75 \, \text{N/m}$- Continue similarly for other data points.
...
#### Formulas Used
-$W = \frac{1}{2}kx^2$-$P = \frac{W}{t}$#### Step-by-Step Solution
1. **Identify Variables**:
   ...
   -$P = \frac{1.1913}{1.5}$-$P \approx 0.7942 \, \text{ W}$#### Final Answer
...
#### Step-by-Step Solution
1. **Identify the given values:**
   - Total voltage,$U = 5.0 \, \text{ V}$- Maximum$U_{ud} = 2.7 \, \text{ V}$- From the graph, for$F = 0.40 \, \text{ N}$,$R_{FSR} \approx 10 \, \text{ k}\Omega$2. **Rearrange the voltage divider formula to solve for$R$:**
...
1. **Identify the velocities at 0.70 s and 0.80 s:**
   -$v_{0.70} = 20.3 \, \text{m/s}$-$v_{0.80} = 22.3 \, \text{m/s}$2. **Calculate the change in velocity and time:**
   -$\Delta v = 22.3 \, \text{m/s} - 20.3 \, \text{m/s} = 2.0 \, \text{m/s}$-$\Delta t = 0.80 \, \text{ s} - 0.70 \, \text{ s} = 0.10 \, \text{ s}$3. **Calculate the acceleration:**
...
1. **Identify the velocities at 1.20 s and 1.30 s:**
   -$v_{1.20} = 29.4 \, \text{m/s}$-$v_{1.30} = 30.9 \, \text{m/s}$2. **Calculate the change in velocity and time:**
   -$\Delta v = 30.9 \, \text{m/s} - 29.4 \, \text{m/s} = 1.5 \, \text{m/s}$-$\Delta t = 1.30 \, \text{ s} - 1.20 \, \text{ s} = 0.10 \, \text{ s}$3. **Calculate the acceleration:**
...
#### Formulas Used
- Ohm's Law:$V = I \times R$#### Step-by-Step Solution
1. **Identify the given values:**
...
#### Key Concepts
- **Energy in an electrical circuit**:$E = I^2 R t$- **Energy conversion**: 15% of the energy converts water to vapor.
- **Latent heat of vaporization**: Energy required to convert water to vapor.

#### Formulas Used
- Energy:$E = I^2 R t$- Mass of water vapor:$m = \frac{E_{\text{ vapor}}}{L}$#### Step-by-Step Solution
1. **Identify the given values:**
   - Current ($I$) = 12,000 A
...
4. **Convert to Percentage**:
   - Remaining percentage:$0.091 \times 100\% \approx 9.1\%$#### Final Answer
...
1. **Convert velocities to m/s:**
   - Initial velocity,$v_i = 30 \, \text{km/h} = \frac{30 \times 1000}{3600} \, \text{m/s} = 8.33 \, \text{m/s}$- Final velocity,$v_f = 400 \, \text{km/h} = \frac{400 \times 1000}{3600} \, \text{m/s} = 111.11 \, \text{m/s}$2. **Calculate the change in momentum:**
...
- **Horizontal Range Formula:**$R = v_0 \cos(\theta) \cdot t$#### Formulas Used
- Horizontal velocity:$v_{0x} = v_0 \cos(\theta)$- Vertical velocity:$v_{0y} = v_0 \sin(\theta)$- Time of flight:$t = 1.90 \, \text{ s}$- Horizontal range:$R = v_{0x} \cdot t$#### Step-by-Step Solution
1. Given:
...
#### Key Concepts
- **Newton's Second Law:**$F = ma$- **Work-Energy Principle:** The work done on an object is equal to the change in its kinetic energy.

#### Formulas Used
-$F = ma$- Work done:$W = \Delta KE = \frac{1}{2}m(v_f^2 - v_i^2)$-$W = F \cdot d$#### Step-by-Step Solution
1. Given:
...
- Calculate for each interval:
     -$d \approx (6.20 + 3.61)/2 \times 30 + (3.61 + 2.45)/2 \times 30 + \ldots + (0.25 + 0.00)/2 \times 44$-$d \approx 297.0 \, \text{ m}$(Note:  The calculation in the original text has a mistake, this is a corrected approximation)
...
#### Step-by-Step Solution
1. **Convert Units**:
   - Pressure:$208 \, \text{ kPa} = 208000 \, \text{ Pa}$- Temperature:$35 \, \text{ MK} = 35000000 \, \text{ K}$2. **Apply Ideal Gas Law**:
...
#### Formulas Used
-$R = \frac{V}{I}$#### Step-by-Step Solution
1. **Identify Given Values**:
...
#### Formulas Used
- Total Power:$P_{\text{ total}} = \frac{V^2}{R_{\text{ total}}}$- Component Power:$P_{\text{ component}} = I^2R_{\text{ component}}$- Percentage:$\frac{P_{\text{ component}}}{P_{\text{ total}}} \times 100\%$#### Step-by-Step Solution
1. **Identify Given Values**:
   - Total voltage,$V = 27 \text{ V}$- Resistance of component,$R_{\text{ component}} = 150 \text{ }\Omega$2. **Determine Total Current from Graph**:
...
1. **Convert velocity to meters per second:**
   - Velocity$v = 2.5 \text{ cm/s} = 0.025 \text{ m/s}$2. **Determine the time duration from the graph:**
...
1. **Identify the given frequency:**
   -$f = 78 \, \text{ min}^{-1}$2. **Convert frequency to seconds:**
...
- **Components of Gravitational Force**:
  - Parallel to incline:$F_{g,\parallel} = F_g \cdot \sin(\theta)$- Perpendicular to incline:$F_{g,\perp} = F_g \cdot \cos(\theta)$#### Step-by-Step Solution
1. **Identify the given values:**
...
---
# Question 62: Radionuklidterapi med$^{67}\text{ Cu}$## Question Images
...
#### Step-by-Step Solution
1. **Given Data**:
   - Effective half-life,$T_{1/2 \text{ eff}} = 47.4 \, \text{ hours}$- Physical half-life of$^{67}\text{ Cu}$,$T_{1/2 \text{ phys}} = 61.9 \, \text{ hours}$(typical value for$^{67}\text{ Cu}$)
...
#### Step-by-Step Solution
1. **Given Data**:
   - Initial activity,$A = 36.0 \, \text{ MBq} = 36.0 \times 10^{6} \ \text{ Bq}$- Energy per decay,$E = 4.34 \times 10^{-14} \, \text{ J}$- Mass of tumor,$m = 10 \, \text{ g} = 0.01 \, \text{ kg}$- Time period,$t = 1 \, \text{ hour} = 3600 \, \text{ s}$2. **Calculate the Absorbed Dose**:
...
#### Step-by-Step Solution
1. Identify the given values:
   - Resistance,$R = 10\,\text{ k}\Omega = 10000\,\Omega$- Current,$I = 0.30\,\text{ mA} = 0.30 \times 10^{-3}\,\text{ A}$2. Substitute the values into the power formula:
...
#### Step-by-Step Solution
1. Identify the given values:
   -$R = 10\,\text{ k}\Omega = 10000\,\Omega$-$U = 3.7\,\text{ V}$-$R_{var}$changes from$2.0\,\text{ k}\Omega$to$15\,\text{ k}\Omega$2. Calculate$U_{ud}$for$R_{var} = 2.0\,\text{ k}\Omega$:
   - Total resistance$R_{\text{ total}} = 10000 + 2000 = 12000\,\Omega$- Voltage drop:
...
3. Calculate$U_{ud}$for$R_{var} = 15.0\,\text{ k}\Omega$:
   - Total resistance$R_{\text{ total}} = 10000 + 15000 = 25000\,\Omega$- Voltage drop:
...
---
# Question 66: Radionuklidterapi med$^{166}\text{ Ho}$## Question Images
...
---
# Question 67: Biologisk halveringstid for$^{131}\text{ I}$## Question Images
...
- **Pressure Formula**:$P = \rho g h$#### Formulas Used
...
3. **Check Conservation**:
   - Mass number:$75 + 1 = 76$,$75 + 1 = 76$- Atomic number:$33 + 1 = 34$,$34$#### Final Answer
The nuclear reaction is:
...
#### Step-by-Step Solution
1. **Identify the given values:**
   - Mass of the train,$m = 1.53 \times 10^{6} \ \text{ kg}$- Height at Airolo,$h_1 = 211 \, \text{ m}$- Height at the highest point,$h_2 = 1151 \, \text{ m}$- Acceleration due to gravity,$g = 9.81 \, \text{m/s}^2$2. **Calculate the height difference:**
...
#### Step-by-Step Solution
1. **Identify the given values:**
   - Mass of the train,$m = 1.53 \times 10^{6} \ \text{ kg}$- Traction force,$F_{traction} = 540 \, \text{ kN} = 540,000 \, \text{ N}$- Friction force,$F_{friction} = 65 \, \text{ kN} = 65,000 \, \text{ N}$- Incline angle,$\theta = 1.55^\circ$- Acceleration due to gravity,$g = 9.81 \, \text{m/s}^2$2. **Calculate the gravitational force component parallel to the incline:**
...
1. **Identify the given values:**
   ...
   - Pressure,$p = 2.0 \, \text{ kPa}$2. **Determine the contact time from the graph:**
...
#### Formulas Used
-$f = \frac{1}{T}$#### Step-by-Step Solution
1. **Identify the Period ($T$):**
...
#### Formulas Used
-$v_{max} = A \omega$-$\omega = 2\pi f$#### Step-by-Step Solution
...
#### Formulas Used
- Average speed$v = \frac{\Delta s}{\Delta t}$#### Step-by-Step Solution
...
- **Newton's Second Law**:$F = ma$#### Formulas Used
- Centripetal force:$F_c = m \cdot a_c = m \cdot \frac{v^2}{r}$- Total force at the bottom:$F_{total} = F_c + mg$#### Step-by-Step Solution
...
#### Formulas Used
- Power formula:$P = V \times I$- **Derivation**: This formula comes from the definition of electrical power, which is the rate at which electrical energy is transferred by an electric circuit.
...
#### Formulas Used
- Heat released by condensation:$Q = m \times L$- **Derivation**: This formula calculates the energy released when a mass$m$of a substance undergoes a phase change, where$L$is the specific latent heat.
  - **Significance**: It helps determine the energy available to heat the air.
- Temperature change formula:$Q = m_{\text{ air}} \times c_{\text{ air}} \times \Delta T$- **Derivation**: This formula calculates the temperature change$\Delta T$of a mass$m_{\text{ air}}$of air with specific heat capacity$c_{\text{ air}}$.
...
#### Step-by-Step Solution
1. **Given Data**:
   - Number of$^{192}\text{ Ir}$nuclei formed:$1.32 \times 10^{12}$- Irradiation time:$2.0 \ \text{ hours} = 7200 \, \text{ seconds}$- Number of target atoms per area:$3.19 \times 10^{23} \ \text{ m}^{-2}$- Cross-section:$4.6 \times 10^{-30} \, \text{ m}^2$2. **Calculate Reaction Rate**:
...
#### Step-by-Step Solution
1. **Given Data**:
   - Activity:$37 \, \text{ kBq} = 37000 \, \text{ Bq}$- Time:$30 \, \text{ minutes} = 0.5 \, \text{ hours}$- Distance:$0.50 \, \text{ m}$- Gamma factor:$0.110 \frac{\mu\text{ Sv} \cdot \text{ m}^2}{\text{ h} \cdot \text{ MBq}}$2. **Calculate Dose Rate**:
...
1. **Identify the initial and final positions and times from the table:**
   - Initial position,$s_i = 0.00 \, \text{ m}$at$t_i = 0.00 \, \text{ ms}$- Final position,$s_f = 0.79 \, \text{ m}$at$t_f = 16.3 \, \text{ ms}$2. **Convert time from milliseconds to seconds:**
...
#### Step-by-Step Solution
1. **Identify the given values:**
   - Mass of sap processed per hour,$m_{\text{ sap}} = 24.6 \, \text{ kg}$- Mass of syrup produced per hour,$m_{\text{ syrup}} = 0.84 \, \text{ kg}$- Mass of water evaporated per hour,$m_{\text{ water}} = 24.6 \, \text{ kg} - 0.84 \, \text{ kg} = 23.76 \, \text{ kg}$- Latent heat of vaporization of water,$L = 2260 \, \text{kJ/kg}$- Time,$t = 1 \, \text{ hour} = 3600 \, \text{ seconds}$2. **Calculate the energy required to evaporate the water:**
...
1. **Ohm's Law**:$V = IR$- Derives from the definition of resistance.
...
1. Identify known values:
   - Resistance,$R = 2.5 \, \text{ k}\Omega = 2500 \, \Omega$- Voltage,$V = 8.0 \, \text{ V}$2. Use the power formula:
...
2. **Ohm's Law**:$V = IR$- Used to relate voltage, current, and resistance.
...
2. **Calculate Acceleration**: Use two points to find acceleration. For example, using$(t_1 = 0.24 \text{ s}, s_1 = 0.03 \text{ m})$and$(t_2 = 0.40 \text{ s}, s_2 = 0.11 \text{ m})$:
   -$s_2 = \frac{1}{2}at_2^2$-$s_1 = \frac{1}{2}at_1^2$- Subtract to find$a$:$a = \frac{2(s_2 - s_1)}{t_2^2 - t_1^2}$-$a = \frac{2(0.11 \text{ m} - 0.03 \text{ m})}{(0.40 \text{ s})^2 - (0.24 \text{ s})^2} = 1.25 \text{ m/s}^2$3. **Find Time for 2.5 m**:
   - Use$s = \frac{1}{2}at^2$with$s = 2.5 \text{ m}$:
   -$2.5 \text{ m} = \frac{1}{2} \times 1.25 \text{ m/s}^2 \times t^2$- Solve for$t$:$t^2 = \frac{2 \times 2.5 \text{ m}}{1.25 \text{ m/s}^2} = 4 \text{ s}^2$-$t = 2 \text{ s}$#### Final Answer
...
1. **Identify Known Values**:
   - Friction force$F = 14.4 \text{ N}$- Distance$d = 20.7 \text{ km} = 20700 \text{ m}$2. **Calculate Work Done**:
   -$W = F \cdot d = 14.4 \text{ N} \times 20700 \text{ m}$-$W = 298080 \text{ J}$#### Final Answer
...
#### Step-by-Step Solution
1. **Identify the given values:**
   - Power,$P = 50 \, \text{ kW} = 50000 \, \text{ W}$- Voltage,$V = 600 \, \text{ V}$2. **Rearrange the formula to solve for current ($I$):**
...
#### Step-by-Step Solution
1. **Identify the given values:**
   - Mass,$m = 19100 \, \text{ kg}$- Radius,$r = 107.5 \, \text{ m}$- Tilt angle,$\theta = 13.5°$2. **Calculate the gravitational force ($F_g$):**
...
---
# Question 97: Kræftbehandling med$^{103}\text{ Pd}$## Question Images
...
#### Formulas Used
- Activity:$A = \lambda N$- Decay Constant:$\lambda = \frac{\ln(2)}{T_{1/2}}$#### Step-by-Step Solution
1. **Given Data**:
...
#### Formulas Used
- Absorbed Dose:$D = \frac{E}{m}$- Energy per Decay: Given as$3.4 \times 10^{-15} \text{ J}$#### Step-by-Step Solution
1. **Given Data**:
